...
HD_PWD='C:/Users/NTH417/ParityGenerator_22200034/ParityGenerator_22200034.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Parity_Gen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Parity_Gen.tcl -notrace
