...
HD_PWD='C:/Users/NTH417/ParityGenerator_22200034/ParityGenerator_22200034.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Parity_Gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Parity_Gen.tcl
