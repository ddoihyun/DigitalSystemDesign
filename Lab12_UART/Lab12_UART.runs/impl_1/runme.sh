...
HD_PWD='C:/Users/ddoihyun/24-2/DigitalSystemDesign/Lab12_UART/Lab12_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_example.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_example.tcl -notrace
