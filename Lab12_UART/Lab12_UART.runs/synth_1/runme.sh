...
HD_PWD='C:/Users/ddoihyun/24-2/DigitalSystemDesign/Lab12_UART/Lab12_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_example.tcl
